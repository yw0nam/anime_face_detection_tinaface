...
data_root = './data/anime_face_detection/'
# data_root = './data/danbooru/' # use this when test model
img_norm_cfg = dict(
...
weights = dict(
    ...
    prefix='backbone')
# weights = dict(
#     filepath='workdir/animeface/epoch_17_weights.pth',
#     prefix='backbone')
# optimizer = dict(filepath='workdir/animeface/epoch_17_optim.pth')
# meta = dict(filepath='workdir/animeface/epoch_17_meta.pth')
